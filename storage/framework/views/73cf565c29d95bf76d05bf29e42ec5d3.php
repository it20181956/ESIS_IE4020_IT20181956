            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <?php endif; ?>
                                ...
                                <form class="login-form mt-4"method="POST" action="<?php echo e(route('password.email')); ?>">
                                   <?php echo csrf_field(); ?>
                                    <div class="row">
                                        <div class="col-lg-12">
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" placeholder="Enter Your Email Address"  required="">
...
<?php /**PATH /home2/codeboysco/public_html/senura/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>