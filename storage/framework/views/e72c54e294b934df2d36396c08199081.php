            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <?php echo e(__('If you did not receive the email')); ?>,
                                <form class="login-form mt-4" method="POST" action="<?php echo e(route('verification.resend')); ?>"">
                                   <?php echo csrf_field(); ?>
                                    <div class="row">
...
<?php /**PATH /home2/codeboysco/public_html/senura/resources/views/auth/verify.blade.php ENDPATH**/ ?>