        ...
        <div class="d-md-flex justify-content-between">
            ...
            <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0">
                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('patients.view')); ?>">Patients</a></li>
...
<div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="overview" id="overview" type="text" class="form-control" placeholder="Bio :">
                                </div>
                            </div>
                <div class="col-md-6">
                                <div class="mb-3">
...
<?php echo $__env->make('admin.inc.adminlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/codeboysco/public_html/senura/resources/views/admin/add-patient.blade.php ENDPATH**/ ?>