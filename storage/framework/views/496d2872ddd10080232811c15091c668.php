            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <?php endif; ?>
                                ...
                                <form class="login-form mt-4"method="POST" action="<?php echo e(route('password.update')); ?>">
                                   <?php echo csrf_field(); ?>
                                    <div class="row">
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e($email ?? old('email')); ?>" required="">
...
unset($__errorArgs, $__bag); ?>
                                           ...
                                           <div class="col-lg-12">
                                            <p class="text-muted">Please enter Confirm Password</p>
                                            <div class="mb-3">
                                                <label class="form-label">Confirm Password<span class="text-danger">*</span></label>
                                                <input type="password" id="password" class="form-control" name="password_confirmation" placeholder="Enter Your Confirm  Password"  required="">
                                        ...
                                        <div class="mx-auto">
                                            <p class="mb-0 mt-3"><small class="text-dark me-2">Remember your password ?</small> <a href="<?php echo e(route('login')); ?>" class="text-dark h6 mb-0">Sign in</a></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<!-- Mirrored from shreethemes.in/doctris/layouts/landing/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Oct 2023 05:30:00 GMT -->
</html>
<?php /**PATH /home2/codeboysco/public_html/senura/resources/views/auth/passwords/reset.blade.php ENDPATH**/ ?>